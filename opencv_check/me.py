...
def tie_img(test_img,add_img):
    add_img = cv2.resize(add_img,(0,0),fx=0.8,fy=0.8)
...
def run(models, test_img, add_img):
    ...
    try:
        ...
        if acc_score > 50:
            ...
            cv2.imshow('add img_kby', result_img)
            file_name = "imgtrain/"+id+"/add_sign.jpg"
...
add_img = cv2.imread("./imgtrain/jk/sign.jpg")
